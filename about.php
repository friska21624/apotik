...
<head>
   ...
   <style>
      body {
         background-color: #D3D3D3; /* Warna background abu muda */
      }
      ...
      <section class="produk-rekomendasi">
         ...
         <div class="products">
            <div class="product">
               ...
               <p>Kebutuhan Lain</p>
               <a href="kebutuhan_lain.php">
                  <button type="button" class="btn text-black" style="background-color: #D6CFC7; margin-top: 3px; border: none; border-radius: 5px;" 
                  onmouseover="this.style.backgroundColor='#777B7E'" 
                  onmouseout="this.style.backgroundColor='#D6CFC7'">Click Here</button>
               </a>
            </div>
            <div class="product">
               ...
               <p>Promo</p>
               <a href="diskon.php">
                  <button type="button" class="btn text-black" style="background-color: #D6CFC7; margin-top: 24px; border: none; border-radius: 5px;" 
                  onmouseover="this.style.backgroundColor='#777B7E'" 
                  onmouseout="this.style.backgroundColor='#D6CFC7'">Click Here</button>
               </a>
            </div>
            <div class="product">
               ...
               <a href="susuAnakDewasa.php">
                  <button type="button" class="btn text-black" style="background-color: #D6CFC7; border: none; border-radius: 5px;" 
                  onmouseover="this.style.backgroundColor='#777B7E'" 
                  onmouseout="this.style.backgroundColor='#D6CFC7'">Click Here</button>
               </a>
            </div>
