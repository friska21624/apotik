...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
   ...
   <link rel="stylesheet" href="../css/style.css">
    <style>
        ...
        background-color: #D3D3D3; /* Ganti warna background di sini */
        }
    ...
    <div class="w-full max-w-5xl bg-[#f5f5dc] p-6 rounded-lg shadow-lg">
        ...
        <form method="post" class="grid grid-cols-3 gap-6">
            ...
            <div class="col-span-3">
                <button class="bg-[#777B7E] text-white font-bold py-3 px-6 rounded-full w-full text-lg hover:bg-[#D3D3D3] " type="submit" name="proses">Klik</button>
            </div>
        </form>
    </div>
