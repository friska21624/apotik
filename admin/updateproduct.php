            ...
            <div class="w-2/3 bg-white rounded-lg shadow-lg p-8">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex space-x-6">
                        <button type="submit" name="update" class="bg-[#66B266] text-white px-4 py-2 rounded-full margin-left [20px] hover:bg-[#89E689]">UPDATE</button>
                        <button type="reset" class="bg-[#66B266] text-white px-4 py-2 rounded-full margin-left [20px] hover:bg-[#89E689]">RESET</button>
                    </div>
                </form>
            </div>
        </div>
